...
![Notebook and Laptop](img/firmbee-com-gcsNOsPEXfs-unsplash.jpg)
> Photo by <a href="https://unsplash.com/@firmbee?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Firmbee.com</a> on <a href="https://unsplash.com/s/photos/visualization?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
...
## Labs
Participate with the instructor and your peers during in-class walkthrough for building interactive visualizations. This is the practical side of the course, where you will develop the coding skills necessary to put the theories we have discussed into practice as interactive visualizations. These have an in-class participation check followed by a take-home "on your own" completion check. They will be released on GitHub for you to review and submit.
